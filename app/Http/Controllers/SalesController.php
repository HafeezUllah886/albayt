    ...
    public function store(Request $request)
    {
        ...
        try
        {
            ...
            foreach($ids as $key => $id)
            {
                ...
                createStock($id,0, $qty, $request->date, "Issued in Inv # $sale->id", $ref, $request->warehouse[$key]);
                /* } */
        ...
        try
        {
            ...
            foreach($ids as $key => $id)
            {
               ...
               /*  $price = $request->price[$key];
                ...
                createStock($id,0, $qty, $request->date, "Issues in Inv # $sale->id", $ref, $request->warehouse[$key]);
                /* } */
            }
