<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
                <h3 class="text-white">BBQ</h3>
            </span>
            <span class="logo-lg">
                <h3 class="text-white mt-3">ALBAYT BBQ</h3>
            </span>
        </a>
        <!-- Light Logo-->
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sales" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-shopping-cart-fill"></i><span data-key="t-apps">Issue</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sales">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a onclick="newWindow('{{ route('sale.create') }}')" class="nav-link"
                                    data-key="t-chat">Create Issue Vouchar</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('sale.index') }}" class="nav-link" data-key="t-chat"> History</a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('accountsList', 'Customer') }}" class="nav-link"
                                    data-key="t-checkboxs-radios">Chief Accounts</a>
                            </li>
                            <li class="nav-item">
